...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2ff8096c-74ab-4b4b-a4ba-670a445b7c9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam Stepper_Motor.comp_name = "Motor_v1_0";
    defparam Stepper_Motor.port_names = "T1, T2";
    defparam Stepper_Motor.width = 2;

    cy_annotation_universal_v1_0 Current_Buffer_5V (
        .connect({
            Net_43,
            Net_10
        })
    );
    defparam Current_Buffer_5V.comp_name = "ExtBuffer_v1_0";
    defparam Current_Buffer_5V.port_names = "Vin, Vout";
    defparam Current_Buffer_5V.width = 2;
    ...
    cy_annotation_universal_v1_0 ISR_OUT (
        .connect({
            Net_18,
            Net_28,
            Net_29,
